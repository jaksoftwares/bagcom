...
export default function UrgencyAndShipping({ product }: UrgencyAndShippingProps) {
  ...
  // No delivery dates — this is a campus meetup marketplace
      ...
      <div className="flex gap-4 p-4 bg-muted/20 border border-border/40 rounded-xl">
        ...
        <div className="space-y-1">
          <p className="text-sm font-bold text-foreground">
            Campus Meetup Exchange
          </p>
          <p className="text-sm font-medium text-muted-foreground">
            After purchase, the seller will contact you to arrange a safe meetup on campus.
          </p>
