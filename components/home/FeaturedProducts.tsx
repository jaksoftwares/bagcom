      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        {isLoading ? (
          <div className="flex gap-4 overflow-hidden">
            {[1, 2, 3, 4, 5].map(i => (
              <div key={i} className="min-w-0 shrink-0 grow-0 basis-full sm:basis-1/2 md:basis-1/3 lg:basis-1/4 xl:basis-1/5 animate-pulse bg-muted/20 rounded-2xl h-[360px] border border-border/20" />
            ))}
          </div>
        ) : (
          <Carousel
