...
export default function SellerSupport() {
  ...
  return (
    <SellerLayout>
      <div className="max-w-[1600px] w-full mx-auto space-y-8 pb-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
          <div>
            ...
            <p className="text-gray-500 font-medium mt-1">Manage your support tickets and contact the admin team.</p>
          </div>
          <Button 
            onClick={() => setActiveTab('NEW')} 
            className="h-12 px-6 font-medium text-sm rounded-xl bg-primary text-primary-foreground shadow-sm hover:bg-primary/90 transition-all gap-2"
          >
