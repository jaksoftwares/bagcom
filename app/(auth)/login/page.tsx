...
import { signIn, signInWithGoogle, getUserProfile } from '@/services/auth/authService';
        ...
        <div className="max-w-md w-full mx-auto space-y-10">
          ...
          <div className="grid grid-cols-1 gap-4">
            <Button 
              type="button"
              variant="outline" 
              className="h-12 rounded-lg border-border/60 font-semibold text-sm gap-2 w-full"
              onClick={async () => {
                try {
        ...
        <div className="relative h-full flex flex-col justify-between border-l border-border/10 pl-12">
          ...
          <div className="relative aspect-video rounded-sm border border-border/40 overflow-hidden shadow-2xl">
            <img 
              ...
              alt="African business owners collaborating"
            />
