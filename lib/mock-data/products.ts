...
export const sampleProducts: Product[] = [
  {
    id: 1,
    slug: 'study-desk-with-ergonomic-chair',
  ...
  {
    id: 4,
    slug: 'queen-size-bed-with-mattress',
  ...
  {
    id: 5,
    slug: 'engineering-textbooks-collection',
  ...
  {
    id: 6,
    slug: 'samsung-microwave-oven-23l',
  ...
  {
    id: 2,
    slug: 'gas-cylinder-13kg-with-cooker',
